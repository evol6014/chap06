...
<body>
	<div class="panel-heading">
		<h3 class="animated bounce">Bootstrap List Page</h3>
	</div>
	<div class="panel-body pull-right">
		<h4><a href="/bootstrap/register">Register</a></h4>
	</div>
	<div class="panel-body">
		<table class="table table-bordered">
			<tr>
				<th>bon</th><th>title</th><th>writer</th>
			</tr>
	...
	$(".pagination a").click(function(e) {
		...
		formObj.submit();
	});	// pagination이라는 클래스가있는 안쪽에 a태그를 찾는다... 클릭하면이벤트를 달어.
